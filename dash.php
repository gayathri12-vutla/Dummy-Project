...
<div class="row">
<div class="col-lg-6">
<span class="logo">Admin Page</span></div>
<?php
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Add a Survey</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove a Survey</a></li>
      </ul>
          </div>
  </div>
</nav>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Enter time limit for the survey in minutes" class="form-control input-md" min="1" type="number">
